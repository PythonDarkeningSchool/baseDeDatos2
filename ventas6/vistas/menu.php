...
<?php require_once "dependencias.php" ?>     <!-- Manda llamar al form. dependencia -->
...
<body>
  ...
  <div id="nav">
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">  <!-- menu pegajoso -->
      <div class="container">
